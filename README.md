...
| --- | --- | --- |
| **[CivPar](https://civpar.de/)** | Architecture and full build, from an empty repo | NestJS 11 · PostgreSQL · AWS Cognito · React 19 · Terraform |
| **[Lillywait](https://lillywait.com/)** | ~90% of a 3.5-year enterprise platform; built the CI/CD from nothing | .NET Core · SQL Server · IdentityServer4 · React · Azure DevOps |
| **[Schulplus24](https://schulplus24.com/)** | Led and delivered almost single-handedly | NestJS · TypeORM · PostgreSQL · BullMQ · React |
| **[RTSS](https://realtimesafetysolutions.com/)** | Web dashboard, backend API, and Electron kiosk app | Express · Inversify · MongoDB · Next.js · Electron · AWS |
| **[BudgetMentor](https://budgetmentor.com/)** | Promoted to team lead ~4 months in; shipped on time | NestJS · MongoDB · Stripe · React |
| **[BoostyTube](https://boostytube.com/)** · **[NinjaSplitter](https://ninjasplitter.com/)** | Backend lead / major contributor | NestJS · PostgreSQL · Stripe · React · Flutter |

---

## What I work with

**Backend** — NestJS, Node.js, TypeScript, Express, .NET Core / C#, Laravel / PHP, REST, GraphQL
**Data** — PostgreSQL, MongoDB, SQL Server, TypeORM, Prisma, Sequelize, Entity Framework, Redis, BullMQ
**Cloud & DevOps** — AWS (Cognito, ECS, RDS, S3, Lambda), Azure, Terraform, Docker, GitHub Actions, Azure DevOps
**Frontend** — React 16→19, Next.js, Vite, React Native, Electron, TanStack Query
...
**Email** — anasm51096@gmail.com
**Based in** Lahore, Pakistan (UTC+5) · open to remote — EU/UK, Gulf, US overlap
